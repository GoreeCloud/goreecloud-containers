# GoreeCloud Containers — Feature Roadmap

**Status:** Active roadmap control  
**As of:** 2026-09-08  
**Authoritative project record:** Project Specification — Containers  
**Canonical repository:** GoreeCloud/goreecloud-containers
**Drive control:** `GoreeCloud/Feature Roadmap/GoreeCloud Containers/FEATURE-ROADMAP.docx`
...
| --- | --- | --- | --- |
| FR-001 | Reconcile and maintain every current planned or recommended GoreeCloud Containers feature from the authoritative project record and verified repository evidence in this roadmap. | High | Ongoing control |
